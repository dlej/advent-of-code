...
(put (initial-board 0) 0 :on)
(put (initial-board 0) 99 :on)
(put (initial-board 99) 0 :on)
(put (initial-board 99) 99 :on)
...
(defn corner? [board i j]
  (and (or (= i 0) (= i (dec (length board))))
       (or (= j 0) (= j (dec (length (board 0)))))))
